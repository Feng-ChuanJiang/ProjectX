...
public class CompanyRestApiController {
	...
	public ResponseEnvelope<List<UserContactsModel>> getRelatComment(Long userId, String name){
		List<UserContactsModel> userContactsModels=companyService.getTwoRelatCompany(userId,name);
