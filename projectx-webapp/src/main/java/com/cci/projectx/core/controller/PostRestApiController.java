...
public class PostRestApiController {
	...
	public ResponseEnvelope<List<UserContactsModel>> getRelatPost(Long userId, String name){
		List<UserContactsModel> userContactsModels=postService.getTwoRelatCompany(userId,name);
