...
public class HRErrorCode extends ErrorCode {
    ...
    public static final ErrorCode USER_IS_NULL = ErrorCode("20006", "电话不能为空");
    public static final ErrorCode PASSWORD_ID_NULL = ErrorCode("20007", "密码不能为空");
    public static final ErrorCode CAPTCHA_INCORRECT = ErrorCode("20008", "验证码不正确");
    public static final ErrorCode FRIEND_HAVE_EXISTED = ErrorCode("20009", "已经是好友");

    public static final ErrorCode RUNUSER_HAVE_EXISIED = ErrorCode("30000", "用户已经添加过跑步信息，请更新");


    public static final ErrorCode Discuss_NOT_USERID = ErrorCode("40000", "没有选择用户");
